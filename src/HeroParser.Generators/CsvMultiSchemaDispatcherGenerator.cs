...
/// used in the dispatcher have the [GenerateBinder] attribute to ensure the
...
#pragma warning disable RS2008 // Enable analyzer release tracking - not needed for internal generator
    private static readonly DiagnosticDescriptor missingBinderAttributeDiagnostic = new(
        "HERO003",
        "Record type missing [GenerateBinder] attribute",
        "Record type '{0}' used in multi-schema dispatcher does not have [GenerateBinder] attribute. This is required for AOT compatibility.",
...
#pragma warning restore IDE0010
    ...
    private static void EmitDispatcher(SourceProductionContext context, DispatcherDescriptor descriptor)
    {
        ...
        builder.AppendLine("// All record types must have [GenerateBinder] attribute for AOT support");
