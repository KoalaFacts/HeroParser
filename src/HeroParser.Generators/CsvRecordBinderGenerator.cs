...
#pragma warning restore RS2008
    ...
    private static void EmitTypedBinder(SourceProductionContext context, TypeDescriptor descriptor)
    {
        ...
        context.AddSource($"CsvInlineCharBinder.{descriptor.SafeClassName}.g.cs", charBuilder.ToString());
    }
    ...
    private static void EmitTypedBinderRegistration(SourceBuilder builder, string fullyQualifiedName, string safeClassName)
    {
        ...
        var charBinderClassName = $"global::{GENERATED_BYTE_NAMESPACE}.CsvInlineCharBinder_{safeClassName}";
...
#pragma warning restore IDE0010
    ...
    {
        var binderClassName = $"CsvInlineCharBinder_{safeClassName}";
        var allHaveExplicitIndex = members.All(m => m.AttributeIndex.HasValue);
        var charBinderInterface = "global::HeroParser.SeparatedValues.Reading.Binders.ICsvBinder<char, ";
    ...
    private static void EmitCharInlinePropertyBinding(SourceBuilder builder, MemberDescriptor member)
    {
        ...
        // Check for null values if configured
        builder.AppendLine("if (_nullValuesChar is null || !IsNullValue(span, _nullValuesChar))");
        builder.AppendLine("{");
        builder.Indent();
        ...
        if (HasAnyValidation(member))
        {
            EmitCharValidationChecks(builder, member);
        }
    ...
    private static void EmitCharValidationChecks(SourceBuilder builder, MemberDescriptor member)
    {
        if (member.ValidationNotNull)
        {
