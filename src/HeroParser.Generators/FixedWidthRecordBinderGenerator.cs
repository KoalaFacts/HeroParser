...
#pragma warning disable RS2008 // Enable analyzer release tracking - not needed for internal generator
    ...
    private static readonly DiagnosticDescriptor notEmptyOnNonStringDiagnostic = new(
        "HERO014", "NotEmpty only applies to string properties",
    ...
    private static readonly DiagnosticDescriptor lengthOnNonStringDiagnostic = new(
        "HERO015", "MaxLength/MinLength only apply to string properties",
    ...
    private static readonly DiagnosticDescriptor rangeOnNonNumericDiagnostic = new(
        "HERO016", "RangeMin/RangeMax only apply to numeric properties",
    ...
    private static readonly DiagnosticDescriptor patternOnNonStringDiagnostic = new(
        "HERO017", "Pattern only applies to string properties",
