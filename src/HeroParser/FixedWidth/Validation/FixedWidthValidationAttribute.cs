...
/// <summary>
/// Base class for fixed-width field validation attributes.
/// </summary>
[AttributeUsage(AttributeTargets.Property, AllowMultiple = true, Inherited = true)]
public abstract class FixedWidthValidationAttribute : Attribute
{
    /// <summary>
    ...
    /// <param name="rawValue">The raw string value from the fixed-width field.</param>
