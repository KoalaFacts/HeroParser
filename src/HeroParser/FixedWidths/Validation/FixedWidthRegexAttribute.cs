...
/// <summary>
/// Validates that a string fixed-width field matches a regular expression pattern.
/// </summary>
[AttributeUsage(AttributeTargets.Property, AllowMultiple = true, Inherited = true)]
public sealed class FixedWidthRegexAttribute : FixedWidthValidationAttribute
{
    /// <summary>
    ...
    public FixedWidthRegexAttribute(string pattern)
    {
