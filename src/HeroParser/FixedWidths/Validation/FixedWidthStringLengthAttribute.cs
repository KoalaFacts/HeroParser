...
/// <summary>
/// Validates that a string fixed-width field length is within the specified bounds.
/// </summary>
[AttributeUsage(AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
public sealed class FixedWidthStringLengthAttribute : FixedWidthValidationAttribute
{
    /// <summary>
    ...
    public FixedWidthStringLengthAttribute(int maxLength)
        : this(0, maxLength)
    {
    }
    ...
    /// <param name="maxLength">The maximum allowed length.</param>
    public FixedWidthStringLengthAttribute(int minLength, int maxLength)
    {
        if (minLength < 0)
