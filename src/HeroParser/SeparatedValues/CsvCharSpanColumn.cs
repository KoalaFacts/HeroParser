...
public readonly ref struct CsvCharSpanColumn
{
    ...
    /// <summary>
    /// Attempts to parse the column as a <see cref="DateOnly"/> using exact format, culture, and styles.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to parse the column as a <see cref="DateOnly"/> using exact format with invariant culture.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to parse the column as a <see cref="TimeOnly"/> using exact format, culture, and styles.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to parse the column as a <see cref="TimeOnly"/> using exact format with invariant culture.
    /// </summary>
