...
public sealed class CsvTextSource
{
    ...
    /// </summary>
    /// <remarks>Use streaming APIs (<see cref="Csv.ReadFromStream(Stream, HeroParser.SeparatedValues.Core.CsvParserOptions?, System.Text.Encoding?, bool, int)"/>) for large inputs to avoid buffering entire files.</remarks>
