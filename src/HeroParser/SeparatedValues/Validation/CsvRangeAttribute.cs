...
/// <summary>
/// Validates that a numeric field value is within the specified range.
/// </summary>
...
public sealed class CsvRangeAttribute : CsvValidationAttribute
{
    ...
    public CsvRangeAttribute(int minimum, int maximum)
    {
        Minimum = minimum;
        Maximum = maximum;
    ...
    /// <param name="minimum">The minimum allowed value (inclusive).</param>
    /// <param name="maximum">The maximum allowed value (inclusive).</param>
    public CsvRangeAttribute(double minimum, double maximum)
    {
        Minimum = minimum;
        Maximum = maximum;
    ...
    /// <param name="minimum">The minimum allowed value (inclusive).</param>
    /// <param name="maximum">The maximum allowed value (inclusive).</param>
    public CsvRangeAttribute(long minimum, long maximum)
    {
        Minimum = minimum;
        Maximum = maximum;
